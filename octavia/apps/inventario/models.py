...
class Marca(models.Model):
    ...
    TIPOS_MARCAS = ((0, _(u"Original Octavia Lingerie")), (1, _(u"Marcas Autorizadas")))
...
class Producto(models.Model):
    ...
    costo_octavia = models.FloatField(_(u"Costo octavia"), default=0.0)
    activo = models.BooleanField(_(u"Activo"), default=True, db_index=True)
    ...
    cantidad_cajas_prefer = models.PositiveIntegerField(_(u"Cantidad x Cajas octavia"), default=0)
    ...
    by_inactive_price_octavia = models.BooleanField(_(u"Inactivar precio octavia"), default=False)
