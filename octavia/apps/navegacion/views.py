...
from octavia.apps.utils import send_invoice
from octavia.apps.ventas.models import Venta, VentaProducts
from octavia.settings import (
    EPAYCO_PUBLIC_KEY,
...
from ..models import Background, Generic, Pasarelas, Pagina
...
def dict_producto(producto):
    ...
    if discount:
        ...
        if discount.by_costo_mayor:
            descuento_mayor = producto.costo_octavia - (producto.costo_octavia * (descuento / 100))
    ...
    product_dict = {
        ...
        "costo_octavia": producto.costo_octavia,
        ...
        "by_inactive_price_octavia": producto.by_inactive_price_octavia,
...
def productsView(request):
    ...
    for p in productos:
        ...
        if discount:
            ...
            if discount.by_costo_mayor:
                descuento_mayor = p["costo_octavia"] - (p["costo_octavia"] * (descuento / 100))
    ...
    def post(self, request, *args, **kwargs):
        ...
        if pasarela.origen == 0:
            preference = {
                ...
                "items": items,
                "back_urls": {
                    "success": f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/?success=1",
                    "failure": f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/?failure=1",
                    "pending": f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/",
                },
            ...
            url_redirect = f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/"

        elif pasarela.origen == 2:
            response = ventas.referencia
            epayco = EPAYCO_PUBLIC_KEY
            url_redirect = f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/"
            url_response = f"https://www.octaviacolombia.com/redirect_pago/{ventas.id}/"
