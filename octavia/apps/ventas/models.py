...
from octavia.apps.models import Pasarelas
from octavia.apps.utils import generate_random_chars
...
class Venta(models.Model):
    ...
    @property
    def cliente_octavia(self):
        client_octavia_text = "Si" if self.cliente.is_octavia else "No"
        return f'{client_octavia_text}'
