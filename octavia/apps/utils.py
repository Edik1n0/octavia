...
def send_mail_octavia(contx, request):
    titulo = str('FORMULARIO DE CONFIRMACIÓN CLIENTE octavia')
    template = 'modules/email/octavia_confirmation_email.html'
    ...
    titulo_to_client = str('FORMULARIO DE PRE CONFIRMACIÓN CLIENTE octavia')
...
def send_invoice(email, venta, products):
    ...
    subject = 'octavia - Factura de compra'
    body = ""
